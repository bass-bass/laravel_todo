  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="avatar avatar-xs me-2">
        ...
        <h5 class="modal-title" id="modalLabelCreateFeed">日記</h5>
      ...
      <div class="modal-body">
         ...
         <div class="d-flex mb-3">
          <!-- Feed box  -->
          <div class="w-100">
            <textarea id="text-create"　class="form-control pe-4 fs-3 lh-1 border-0" name="content" rows="4" placeholder="どんなことがありました？😁" autofocus></textarea>
          </div>
        </div>
      </div>
      <!-- Modal feed body END -->
      ...
      <div class="modal-footer row justify-content-between">
        ...
        <div class="row ml-auto mr-3 mb-3">
          <div class="col-lg-4 text-sm-end">
            <button type="submit" name="post" class="btn btn-success-soft" id="create-submit">投稿する</button>
          </div>
        </div>
      <!-- Modal feed footer -->
    </div>
